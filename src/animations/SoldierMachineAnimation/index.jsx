...
const SoldierMachineAnimation = () => {
    ...
    return (
        <>
            <div id="soldierBotAnimationDiv">
                <div className="AnimationBlock">
                    <p>Soldier Bot Animation</p>
                    <div id="container" />
                </div>
                <br />
                <div className="refer-links">
                    <a href="https://threejs.org" target="_blank" rel="noopener">three.js</a> webgl - skinning and morphing<br />
                    <a href="https://github.com/mrdoob/three.js/blob/master/examples/webgl_animation_skinning_blending.html" target="_blank" rel="noopener">GitHub</a>,
                </div>
            </div>
        </>
    )
...
export default SoldierMachineAnimation
