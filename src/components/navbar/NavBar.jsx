...
const routePaths = [
  ...
  { label: 'About Us', path: '/aboutus', key: 'aboutus' }
]
    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          <Typography variant='h5' noWrap onClick={() => { routeToLink('/') }}>
            React ThreeJS
          </Typography>
        </Toolbar>
      </AppBar>
      ...
      >
        ...
        <List>
          {routePaths.map((routeData, index) => {
            return (
              <ListItem onClick={() => { routeToLink(routeData.path) }} button key={routeData.key}>
                <ListItemIcon><InboxIcon /></ListItemIcon>
                <ListItemText primary={routeData.label} />
              </ListItem>
            )
          })}
        </List>
